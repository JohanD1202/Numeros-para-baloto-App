...
class Balotas extends StatefulWidget {
  const Balotas({Key? key}) : super(key: key);

  @override
  _BalotasState createState() => _BalotasState();
}

class _BalotasState extends State<Balotas> {
  ...
  final Color color = Colors.yellow.shade600;
...
void _showInterstitialAd() {
  if (_isAdLoaded && mounted && _interstitialAd != null) {
    _interstitialAd.show();
  } else {
    debugPrint('InterstitialAd not loaded or widget is disposed.');
  }
}
...
void dispose() {
  if (_interstitialAd != null) {
    _interstitialAd.fullScreenContentCallback = null; // Limpiar el callback antes de dispose
